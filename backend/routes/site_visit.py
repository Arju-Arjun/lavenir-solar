...
def save_site_visit(customer_id):
    ...
    visit.work_done = "Completed" if visit.panel_capacity > 0 and visit.system_capacity > 0 and visit.feasibility == "Yes" and visit.project_cost > 0 and visit.location and visit.quotation_file and visit.agreement_file and visit.aadhaar and visit.pan and visit.kseb_bill and visit.bank_passbook and visit.land_tax and visit.building_tax and visit.signature else "Pending"
    db.session.commit()
